            ...
            body: ConditionalBuilder(
                ...
                builder: (context)=> RefreshIndicator(
                  ...
                  child: ListView.builder(
                    itemBuilder: (context, index) => getTemp(cubit.weatherModel!, context),
           ...
           SizedBox(
             ...
             child: ConditionalBuilder(
               ...
               builder: (context) => ListView.separated(
                 ...
                 itemCount: WeatherAppCubit.get(context).forecastModel!.list!.length,
               ),
               fallback: (context) => const Center(child: CircularProgressIndicator()),
             ),
           ),
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          ...
          debugPrint('onTaaaaaaaaaaaa: ${WeatherAppCubit.get(context).weatherModel!.main!.temp!.round()-273.15.round()}');
          Navigator.push(
            context,
            MaterialPageRoute(
